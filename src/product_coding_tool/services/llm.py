"""Reusable Azure OpenAI / compatible LLM service for product coding.

This file intentionally preserves the scraping agent LLM service contract so the
product coding package uses the same enterprise/stateless endpoint integration.
"""
...
class LLMService:
    ...
    def __init__(self, config: LLMConfig | None = None) -> None:
        ...
        try:
            ...
            raise RuntimeError(
                "The `openai` package with AzureOpenAI support is required when LLM is enabled. "
                "Install project dependencies or set PCT_LLM_ENABLED=false/PCA_LLM_ENABLED=false."
            ) from exc
